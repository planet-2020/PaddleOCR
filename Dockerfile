...
RUN pip3.7 install paddlepaddle==2.0.0rc1 -i https://mirror.baidu.com/pypi/simple
...
CMD ["/bin/bash","-c","hub install deploy/hubserving/ocr_system/ && hub serving start -m ocr_system --use_multiprocess --workers"]
